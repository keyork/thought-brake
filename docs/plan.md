...
6. schema v3/v4 的 20 题 BOCPD probe 已完成：0 个 soft stop，当前 BOCPD 退化成 hard fallback；结论见 [bocpd_probe_20_report.md](bocpd_probe_20_report.md)
7. 下一步用 enhanced-detail probe 重新跑 20 题，观察 `p_change/z/r_map` 和 blocked condition
